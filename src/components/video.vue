<template>
  ...
  >
    ...
    <div class="player-box">
      <img class="player-cover" :src="musicImg" alt="" />
      <div class="player-ft">
        ...
        <div class="player-btn">
          ...
          <div class="play">            
            <el-icon v-if="isPause"><VideoPlay /></el-icon>
            <el-icon v-else><VideoPause /></el-icon>
          </div>
          <div class="next"><el-icon><CaretRight /></el-icon></div>          
          <el-slider
          v-model="sliderVal"
            :min="sliderMin"
            :max="sliderMax"
...
export default {
  ...
  setup() {
    ...
    const formatTime=(time)=> { // 格式化毫秒，返回String型分秒对象
  // 有可能没获取到，为NaN
